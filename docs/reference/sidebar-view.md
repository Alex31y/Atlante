...
- View container: `atlante` (activity bar), icon `resources/atlante-icon.svg`
- View: `atlante.sidebarView` (type: `webview`)
...
- **Remove button** - per-entry `x` triggers [remove-project](remove-project.md)
